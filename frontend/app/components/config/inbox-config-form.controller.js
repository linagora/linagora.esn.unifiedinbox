  ...
  function InboxConfigFormController(
    ...
    function onForwardingChange() {
      ...
      if (originalConfigs.forwarding.value && !self.forwardingConfigs.forwarding.value) {
        $modal({
          templateUrl: '/unifiedinbox/app/components/config/disable-forwarding/inbox-config-form-disable-forwarding.html',
          backdrop: 'static',
          placement: 'center',
    ...
    function onLocalCopyChange() {
      if (originalConfigs.isLocalCopyEnabled.value && !self.forwardingConfigs.isLocalCopyEnabled.value) {
        $modal({
          templateUrl: '/unifiedinbox/app/components/config/disable-local-copy/inbox-config-form-disable-local-copy.html',
          backdrop: 'static',
          placement: 'center',
